...
do
  case \$arg in
    'master')
      ...
      KUBECONFIG=/etc/kubernetes/admin.conf kubectl create -f https://raw.githubusercontent.com/initd-daemon/kubernetes-terraform-scaleway/master/kubernetes-dashboard.yaml
      break
      ;;
    'slave')
